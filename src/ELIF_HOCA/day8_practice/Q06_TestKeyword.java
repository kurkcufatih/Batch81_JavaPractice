package ELIF_HOCA.day8_practice;
...
*/
    ...
    public static void testSonucu(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length; i++) { //her bir ogrenciye bakar i=ogrenci
            int sayac = 0; //her bir ogrencinin dogru cevabini sayacagi icin, yasac buraya eklendi
            for (int j = 0; j < answers[i].length; j++) { //her bir ogrencinin cevaplarina bakar j=ogrenci cevaplari
                if (answers[i][j] == keys[j]) { //cevap anatari ile ogrenci cevaplari karsilastiriliyor
                   sayac++;
                }
            }
